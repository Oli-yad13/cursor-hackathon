...
export const registerDoctor = (data) =>
  axios.post(`${API_URL}/api/doctors/register/`, data);
...
export const createAppointment = (appointmentData) => {
  const token = localStorage.getItem("token");
  return axios.post(`${API_URL}/api/doctors/teleconsults/`, appointmentData, {
    headers: { Authorization: `Bearer ${token}` },
  });
};
...
export const getPatientAppointments = () => {
  const token = localStorage.getItem("token");
  return axios.get(`${API_URL}/api/doctors/teleconsults/`, {
    headers: { Authorization: `Bearer ${token}` },
  });
};
...
export const updateAppointmentStatus = (appointmentId, status) => {
  const token = localStorage.getItem("token");
  return axios.patch(`${API_URL}/api/doctors/teleconsults/${appointmentId}/`, { status }, {
    headers: { Authorization: `Bearer ${token}` },
  });
};
...
export const cancelAppointment = (appointmentId) => {
  const token = localStorage.getItem("token");
  return axios.patch(`${API_URL}/api/doctors/teleconsults/${appointmentId}/`, { status: 'cancelled' }, {
    headers: { Authorization: `Bearer ${token}` },
  });
};