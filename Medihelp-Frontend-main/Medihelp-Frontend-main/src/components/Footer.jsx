...
const Footer = () => {
  ...
  const privacyContent = `
    ...
    <p className="mb-2">At TenaHub, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our services.</p>
  ...
  const termsContent = `
    ...
    <p className="mb-2">Welcome to TenaHub. By accessing or using our services, you agree to be bound by these Terms of Service.</p>
    <p className="mb-2">You must be at least 13 years old to use our services. You are responsible for maintaining the confidentiality of your account and password. TenaHub is not a substitute for professional medical advice.</p>
  ...
  return (
    <footer className="bg-gray-800 text-white py-10">
      <div className="container mx-auto text-center px-4">
        <p className="mb-4">© 2025 TenaHub. All rights reserved.</p>
