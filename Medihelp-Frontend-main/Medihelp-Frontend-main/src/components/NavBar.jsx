...
const NavBar = () => {
  ...
  return (
    <nav className="fixed top-2 left-1/2 transform -translate-x-1/2 w-[95%] max-w-5xl shadow-lg z-50 bg-white/80 dark:bg-black/80 backdrop-blur-md border border-gray-200/20 dark:border-gray-800/20 rounded-full">
      <div className="px-3 py-0.5 flex justify-between items-center">
        <div className="flex items-center overflow-visible">
          <img src="/logo.png" className="w-20 h-20 -my-3" />
        </div>
